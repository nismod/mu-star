...
def econ_utilities(
    ...
    # with plotting.publication_style():
    #     fig, ax = plt.subplots()
    ...
    #             zoom=10,
    #             attribution="",
    #         )  # ctx.providers.CartoDB.Positron ; ctx.providers.CartoDB.DarkMatter
    #     except Exception as e:
    #         pass

    # plt.savefig("../../figures/economic/utilities_voronois.png", dpi=300)
    ...
    for var in output_cols_list:
        ...
        fig.colorbar(scatter, ax=axs[-1], fraction=0.02, pad=0.04, label="Total Output (USD $)")
